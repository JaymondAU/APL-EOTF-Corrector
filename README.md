...
The `Gigabyte_MO27Q2_EOTF_Correction_LUT.png` included in this repository by default was calibrated specifically for the **Gigabyte MO27Q2 in its Peak 1000 mode**.
